...
output "alb_sg_group_vpc_id" {
  ...
  value       = module.alb-security-group.security_group_vpc_id
}

## public_bastion_sg_group_name
output "alb_sg_group_name" {
  description = "The name of the security group"
  value       = module.alb-security-group.security_group_name
}

# Private ECS Instances Security Group Outputs
## private_sg_group_id
...
output "ecs_sg_group_vpc_id" {
  description = "The VPC ID"
  value       = module.ecs-security-group.security_group_vpc_id
}
